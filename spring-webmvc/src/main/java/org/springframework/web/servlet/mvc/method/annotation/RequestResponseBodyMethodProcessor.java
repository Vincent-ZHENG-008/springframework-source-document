...
public class RequestResponseBodyMethodProcessor extends AbstractMessageConverterMethodProcessor {
	...
	public boolean supportsParameter(MethodParameter parameter) {
		// MethodParameter argument have @RequestBody annotation
		return parameter.hasParameterAnnotation(RequestBody.class);
	}

	@Override
	public boolean supportsReturnType(MethodParameter returnType) {
		// Method have @ResponseBody or component class have @ResponseBody
	...
	public Object resolveArgument(MethodParameter parameter, @Nullable ModelAndViewContainer mavContainer,
		...
		// parameter：HandlerMethod$HandlerMethodParameter
		parameter = parameter.nestedIfOptional();
		// 读取 Servlet Body 数据，并通过 MessageConverter 进行数据解析
		Object arg = readWithMessageConverters(webRequest, parameter, parameter.getNestedGenericParameterType());
		// 获取 MethodParameter 上的 variable-name(参数名)
	...
	public void handleReturnValue(@Nullable Object returnValue, MethodParameter returnType,
		...
		// 设置 MvcContainer RequestHandler 标志位为true：已处理
		mavContainer.setRequestHandled(true);
		ServletServerHttpRequest inputMessage = createInputMessage(webRequest);
		ServletServerHttpResponse outputMessage = createOutputMessage(webRequest);

		// Try even with null return value. ResponseBodyAdvice could get involved.
		// 通过 MappingAbstractMessageConverter 输出到 HttpServletResponse
