...
public class HandlerMethodArgumentResolverComposite implements HandlerMethodArgumentResolver {
	...
	private HandlerMethodArgumentResolver getArgumentResolver(MethodParameter parameter) {
		// argumentResolverCache 缓存：避免频繁反射
		...
		if (result == null) {
			...
			// ServletMethodAttributeMethodProcessor
			// RequestResponseBodyMethodProcessor：@RequestBody
			// RequestPartMethodArgumentResolver
			// RequestHeaderMethodArgumentResolver
			// RequestHeaderMapMethodArgumentResolver
			// ServletCookieValuesMethodArgumentResolver
			...
			// MapMethodProcessor
			// ErrorMethodArgumentResolver
			// SessionStatusMethodArgumentResolver
			// UriComponentBuilderMethodArgumentResolver
